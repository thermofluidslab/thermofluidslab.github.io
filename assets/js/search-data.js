    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "",handler: () => {
              window.location.href = "/books/ja/the_godfather/";
          ...
          section: "News",handler: () => {
              window.location.href = "/news/ja/announcement_2/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/ja/1_project/";
            },},{id: "projects-projeto-2",
          title: 'projeto 2',
          description: "um projeto com imagem de fundo e comentários do giscus",
          section: "Projects",handler: () => {
              window.location.href = "/projects/ja/2_project/";
            },},{id: "projects-projeto-3-com-um-nome-bem-longo",
          title: 'projeto 3 com um nome bem longo',
          description: "um projeto que redireciona pra outro website",
          section: "Projects",handler: () => {
              window.location.href = "/projects/ja/3_project/";
            },},{id: "projects-projeto-4",
          title: 'projeto 4',
          description: "outro sem imagem",
          section: "Projects",handler: () => {
              window.location.href = "/projects/ja/4_project/";
            },},{id: "projects-projeto-5",
          title: 'projeto 5',
          description: "um projeto com imagem de fundo",
          section: "Projects",handler: () => {
              window.location.href = "/projects/ja/5_project/";
            },},{id: "projects-projeto-6",
          title: 'projeto 6',
          description: "um projeto sem imagem",
          section: "Projects",handler: () => {
              window.location.href = "/projects/ja/6_project/";
            },},{
        id: 'social-email',
        title: 'Send an email',
        section: 'Socials',
